...
SPA_SHELL = os.path.join(DIRECTORY, 'spa.html')
...
class SPAHandler(http.server.SimpleHTTPRequestHandler):
    ...
    # Static asset directories/extensions that should be served as files
    ...
    def do_GET(self):
        ...
        # Serve actual static assets (CSS, JS, images, page fragments, spa.html itself)
        is_static = (
        ...
        # Everything else (/, /products, /contact, /product-xeros.html, etc.)
        # gets the SPA shell
        self.path = '/spa.html'
        return super().do_GET()
